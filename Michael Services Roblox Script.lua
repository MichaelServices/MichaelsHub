...
local Window = OrionLib:MakeWindow({Name = "Michael Services Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Hub292-172"})
...
ToolName.Text = "No Second Chance"
